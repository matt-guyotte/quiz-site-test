...
import {startLabels} from './javascript/javascript-quiz-1'; 
import {questions} from './javascript/javascript-quiz-1';
import {endLabels} from './javascript/javascript-quiz-1'; 
...
class EndScreen extends React.Component {
  render() {
    if (this.props.currentQuestion === 7 && this.props.score === 4) {
      return (
        <Container fluid> 
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
    ...
    if (this.props.currentQuestion === 7 && this.props.score < 10) {
      return (
        <Container fluid> 
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
    ...
    if (this.props.currentQuestion === 7 && this.props.score < 20) {
      return (
        <Container fluid> 
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
    ...
    if (this.props.currentQuestion === 7 && this.props.score < 30) {
      return (
        <Container fluid> 
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
    ...
    if (this.props.currentQuestion === 7 && this.props.score >= 30) {
      return (
        <Container fluid> 
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
              <h1> {endLabels[4].result} </h1> 
            </Col>
          </Row>
          <Row className = "m-auto picture-row"> 
            <img className = "quizImage" src = {endLabels[4].imgSrc} fluid /> 
          </Row>
          <Row className = "m-auto default-row"> 
            <Col className = "m-auto text-center"> 
              <p> {endLabels[4].descrip} </p> 
            </Col>
          </Row>
          <Row className = "m-auto default-row" onClick = {this.props.reset}> 
            <Col className = "m-auto text-center"> 
              <Button variant="primary"> {endLabels[4].takeAgain} </Button> 
            </Col>
          </Row>
        </Container>
      )
